    ...
    if is_finetuned:
        ...
        model, _, _ = fairseq.checkpoint_utils.load_model_ensemble_and_task(
            [checkpoint_path], arg_overrides={"data": dict_path,
                                              "w2v_path": parameters.PRETRAINED_CHECKPOINT}
        )
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--pytorch_dump_folder_path", default=None, type=str,
    ...
    f = parameters.FINETUNED_CHECKPOINT
    args = parser.parse_args()
    '''
    os.makedirs(parameters.HF_DIRECTORY_PATH, exist_ok=True)
    convert_wav2vec2_checkpoint(
        checkpoint_path=parameters.FINETUNED_CHECKPOINT,
        pytorch_dump_folder_path=parameters.HF_DIRECTORY_PATH,
        config_path=parameters.HF_CONFIG,
        dict_path=parameters.DICT
    )
